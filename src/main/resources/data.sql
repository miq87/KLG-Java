...
INSERT INTO Reservation (id, tenant_id, landlord_id, place_id, date_from, date_to, price)
    VALUES (1, 1, 4, 1, '2022-05-01', '2022-05-03', 400);
INSERT INTO Reservation (id, tenant_id, landlord_id, place_id, date_from, date_to, price)
    VALUES (2, 2, 3, 2, '2022-04-20', '2022-04-24', 200);
INSERT INTO Reservation (id, tenant_id, landlord_id, place_id, date_from, date_to, price)
    VALUES (3, 3, 2, 3, '2022-04-22', '2022-04-30', 300);
INSERT INTO Reservation (id, tenant_id, landlord_id, place_id, date_from, date_to, price)
    VALUES (4, 4, 1, 4, '2022-05-01', '2022-05-08', 450);
INSERT INTO Reservation (id, tenant_id, landlord_id, place_id, date_from, date_to, price)
    VALUES (5, 2, 1, 1, '2022-03-21', '2022-03-28', 400);
